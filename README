...
Zemote is a project to rethink the idea of a programmable remote controls, trying to make it simpler.
...
Zemote offers you a remote control that is as simple as possible.
It is not only simple to use, it is also simple to program. 

#Programming a zemote control

---

To program a zemote controller, plug the zemote controller into your computer.

Connect to the device with the zemote host program.

Select your channel or button to program, and then use your original remotes to program zemote.

Click finish programming on the zemote host and then you're done with one. 

Repeat the process for all the channels or buttons you would like to program.
