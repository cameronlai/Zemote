...
class mainPanel(wx.Panel):
    ...
    def __DoLayout(self):
        ...
        self.testButton = wx.Button(buttonPanel, -1, name='Test', label='Test Button')
        self.saveToEEPROMButton = wx.Button(buttonPanel, -1, name='Save', label='Save settings to EEPROM')
        self.readFromEEPROMButton = wx.Button(buttonPanel, -1, name='Reset', label='Reset settings to EEPROM')
        ...
        buttonSizer.AddMany([
            ...
            (self.finishButton, 0, wx.ALIGN_CENTER),
            (self.saveToEEPROMButton, 0, wx.ALIGN_CENTER),
            (self.testButton, 0, wx.ALIGN_CENTER),
            (self.readFromEEPROMButton, 0, wx.ALIGN_CENTER),        
        ])
